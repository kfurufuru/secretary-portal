...
function JuyoritsuGainenPage({ onNav, data }) {
  return (
    <div>
      ...
      <p style={{margin: '0 0 12px', fontSize: 13, lineHeight: 1.7, color: 'var(--ink-2)'}}>
        3工場の<strong>負荷曲線を1日（24h）でプロット</strong>。各工場のピーク（●）が時刻バラバラなので、
      ...
      <div style={{margin: '16px 0', padding: 16, background: '#fff', border: '1px solid var(--bd)', borderRadius: 8}}>
        <div style={{fontSize: 13, fontWeight: 600, color: 'var(--ink-2)', marginBottom: 8}}>📈 1日の負荷曲線（kW vs 時刻）</div>
        <svg viewBox="0 0 820 460" style={{width: '100%', height: 'auto'}}>
          <defs>
          ...
          <polyline points="70,367 166,367 261,329 356,279 452,317 547,329 643,342 706,355 770,367" fill="none" stroke="#d33" strokeWidth="2"/>
          <polyline points="70,367 166,367 261,342 356,304 452,253 547,291 643,317 706,329 770,355" fill="none" stroke="#2a8" strokeWidth="2"/>
          <polyline points="70,329 166,329 261,342 356,355 452,342 547,329 643,317 706,304 770,329" fill="none" stroke="#a06" strokeWidth="2"/>
          <polyline points="70,304 166,304 261,253 356,177 452,152 547,190 643,215 706,228 770,279" fill="none" stroke="#0e3a6e" strokeWidth="3.5"/>

          <circle cx="356" cy="279" r="5" fill="#d33"/>
          <text x="356" y="271" textAnchor="middle" fontSize="11" fontWeight="700" fill="#d33">A 40kW</text>
          <circle cx="452" cy="253" r="5" fill="#2a8"/>
          <text x="476" y="251" textAnchor="start" fontSize="11" fontWeight="700" fill="#2a8">B 50kW</text>
          <circle cx="706" cy="304" r="5" fill="#a06"/>
          <text x="706" y="296" textAnchor="middle" fontSize="11" fontWeight="700" fill="#a06">C 30kW</text>

          <circle cx="452" cy="152" r="7" fill="#0e3a6e" stroke="#fff" strokeWidth="2"/>
        ...
        <div style={{fontSize: 12, color: 'var(--ink-3)', marginTop: 8, lineHeight: 1.7}}>
          ※ 紺の太線＝3工場合算（合成需要）。●＝各工場のピーク（A:9時 / B:12時 / C:20時）。<br/>
          ・<strong style={{color:'#a11'}}>赤点線 120 kW</strong>＝「●3つの単純合計」（時刻無視）＝<strong>不等率の分子</strong><br/>
          ・<strong style={{color:'#0e3a6e'}}>◎ 90 kW</strong>＝「合計線の最大値」（昼12時の同時最大）＝<strong>不等率の分母</strong><br/>
          ・差 30 kW＝ピーク時刻ズレによる「分散効果」 → <strong>不等率 = 120 / 90 = 1.33</strong>
        </div>
      </div>
