...
function MachigaiNotePage({ pageId, data, onNav }) {
  ...
  async function toggleExpand(r) {
    ...
    try {
      ...
      // 問題ブロック + 直後の「解答・解説」兄弟要素を収集
      // !!! abstract "問題" → <div class="admonition abstract">
      // ??? success "解答・解説" → <details class="success">  ← 次兄弟として配置される
      const ANSWER_RE = /解答|解説|答え|ヒント|補足|ポイント/;
      const collected = [foundEl];
      let sib = foundEl.nextElementSibling;
      for (let i = 0; sib && i < 5; i++) {
        // 次の問題ブロック or 見出しに当たったら停止
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        💡 各記事の理解度ボタンで「<strong style={{ color: '#dc2626' }}>間違えた</strong> / <strong style={{ color: '#f97316' }}>要確認</strong> / <strong style={{ color: '#f59e0b' }}>うる覚え</strong>」を選ぶと、ここに自動で集約されます。法規wiki（hoki）・電験wiki両方の記録を横断して表示。
      </div>
            ...
            >
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center', marginBottom: 6 }}>
                ...
                <span style={{
                  ...
                  padding: '1px 6px',
                  borderRadius: 3,
                  background: r.source === 'hoki' ? 'var(--accent-soft)' : 'var(--bg-2)',
                  color: 'var(--ink-2)',
                }}>
  ...
  return (
    <div>
      ...
      <UpdateLog entries={[
        ...
        { date: "2026-05-09", content: "v1.1: B種接地抵抗の遮断時間条件を電技解釈第17条第2項の正規表現に修正（誤『1秒以内→300・0.5秒以内→600』→ 正『1秒超〜2秒以内→300・1秒以内→600』）", reason: "誤数値修正・古舘さん指摘" },
      ]} />
  ...
  return (
    <div>
      ...
      <MemTable
        ...
        note="B種の 150/Ig は「1秒超〜2秒以内に自動遮断→300/Ig、1秒以内に自動遮断→600/Ig」に緩和される（電技解釈第17条第2項）"
      />
      ...
      <UpdateLog entries={[
        ...
        { date: "2026-05-09", content: "B種接地のnote内記述を電技解釈第17条第2項の正規表現に修正（誤『1秒以内→300/Ig』→ 正『1秒超〜2秒以内→300/Ig、1秒以内→600/Ig』）", reason: "並列監査で発見・古舘さん指摘の波及修正" },
      ]} />
      <PageNav
        prevId="top"            prevTitle="トップ"
...
function RikkakuIchiranPage({ onNav, data }) {
  return (
    <div>
      ...
      <ConclusionBox>
        <ul>
          <li><strong>建造物上部</strong>: 低圧2m / 高圧2m / 特高3m（電技解釈<a href="https://kfurufuru.github.io/denken-wiki/articles/kaishaku/71/" target="_blank" rel="noopener noreferrer">第71条「建造物との接近」</a>）</li>
          <li><strong>建造物側方</strong>: 低圧1m / 高圧1.2m / 特高3m（同 第71条）</li>
          <li><strong>道路横断</strong>: 低高圧共通6m / 特高6m（電技解釈第68条 68-1表）</li>
          <li><strong>鉄道横断</strong>: 低圧5.5m / 高圧5.5m / 特高6m（同 第68条）</li>
        </ul>
      </ConclusionBox>
      ...
      <MemTable
        ...
        note="道路横断は低圧・高圧・特高すべて6m（電技解釈第68条 68-1表より共通）。鉄道横断は低圧・高圧とも5.5mで同じ"
      />
      ...
      <QuickReview items={[
        ...
        { q: "道路横断で低圧と高圧の高さの差は？",           a: "差ゼロ（低高圧共通6m）" },
      ]} />
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：建造物上部/側方の典拠条文（§71「建造物との接近」）への直接リンクを追加。道路/鉄道横断は §68 と明示", reason: "B7 phaseHoki-G3 F9 指摘（典拠条文の直接参照）" },
    ...
    <div>
      ...
      <ConclusionBox>
        <ul>
          ...
          <li>電気工作物は <strong>4区分</strong>（一般用 / 小規模事業用 / 自家用 / 電力会社等）— <strong>2022年改正（令和5年3月20日施行）</strong>で「小規模事業用」新設</li>
          <li>太陽光は <strong>10kW未満=一般用 / 10〜50kW未満=小規模事業用 / 50kW以上=自家用</strong>（旧「50kW未満=一般用」は廃止）</li>
        </ul>
      </ConclusionBox>
      ...
      <QuickReview items={[
        ...
        { q: "太陽光30kWの区分は？",              a: "小規模事業用電気工作物（10kW以上50kW未満・2022年改正後）" },
        { q: "太陽光50kWの区分は？",              a: "自家用電気工作物（50kW以上は自家用。「未満／以上」に注意）" },
...
function ShuninGijutsusyaPage({ onNav, data }) {
  ...
  return (
    <div>
      ...
      <ConclusionBox>
        <ul>
          <li><strong>第一種</strong>: すべての事業用電気工作物（電圧・出力ともに制限なし）</li>
          <li><strong>第二種</strong>: 電圧 17 万 V 未満の事業用電気工作物</li>
          <li><strong>第三種</strong>: 電圧 5 万 V 未満（ただし出力 5,000 kW 以上の発電所を除く）</li>
          <li>選任義務（法 43 条）と工作物の届出義務（法 42 条）は<strong>別個の手続</strong></li>
          <li>外部委託承認は<strong>「主任技術者を選任しないことができる制度」</strong>。代表例は 7,000 V 以下で受電する需要設備</li>
        </ul>
      </ConclusionBox>
      ...
      <QuickReview items={[
        ...
        { q: "第二種の監督範囲は？",                              a: "電圧 17 万 V 未満の事業用電気工作物" },
        { q: "第一種の監督範囲は？",                              a: "すべての事業用電気工作物（電圧・出力制限なし）" },
        { q: "電気事業法 43 条 2 項は？",                         a: "自家用設置者（小規模事業用を除く）に限る、免状を持たない者の許可選任" },
        { q: "電気事業法 43 条 3 項は？",                         a: "主任技術者の選任・解任の届出（遅滞なく）" },
        { q: "電気事業法 43 条 4 項は？",                         a: "主任技術者の誠実義務" },
        { q: "電気事業法 43 条 5 項は？",                         a: "従事する者の指示遵守義務（主任技術者の指示に従う・条文表現は『従業者』ではない）" },
        { q: "兼任承認の数字 4 つは？",                            a: "7,000 V 以下 / 2,000 kW 未満 / 6 カ所以内 / 2 時間以内" },
        { q: "兼任の手続種別は？（届出か承認か）",                a: "承認（届出ではない）" },
        { q: "外部委託承認は外部から選任する制度？",              a: "違う。主任技術者を選任しないことができる制度" },
        { q: "外部委託の月次点検頻度は？",                         a: "原則 1 月に 1 回以上（令和 7 年改正で一定要件下では 3 月に 1 回も可）" },
      ]} />
...
function HoanKiteiPage({ onNav, data }) {
  return (
    <div>
      ...
      <ConclusionBox>
        <ul>
          <li><strong>対象</strong>: <strong>事業用電気工作物（小規模事業用電気工作物を除く）を設置する者</strong>（電気事業法 第42条第1項）— 電気事業者の事業用設備 + 自家用電気工作物の双方が対象。「自家用のみ」と狭めない</li>
          <li><strong>届出時期</strong>: 使用の開始<strong>前</strong>に届出</li>
          <li><strong>変更時</strong>: <strong>遅滞なく</strong>届出（事前届出ではない）</li>
          <li><strong>記載事項の核心</strong>（施行規則 第50条）: <strong>職務分掌・保安教育・巡視点検・運転操作・保全方法・非常時措置・記録</strong>（頭文字「職保巡措記」）</li>
          <li><strong>KAISEI-2022-001</strong>: 2023年3月施行で<strong>小規模事業用電気工作物（10kW以上50kW未満太陽光・20kW未満風力等）は保安規程の対象外</strong></li>
        </ul>
      </ConclusionBox>
      ...
      <QuickReview items={[
        ...
        { q: "施行規則第50条の核心7項目の頭文字は？",   a: "職保巡措記（職務分掌・保安教育・巡視点検・非常時措置・記録）" },
    ...
    <div>
      ...
      <ConclusionBox>
        <ul>
          ...
          <li><strong>感電要件</strong>: 死亡 OR <strong>病院・診療所に入院した</strong>負傷（電気関係報告規則第3条第1項第1号・軽傷の通院は対象外）</li>
      ...
      <TrapTable traps={[
        ...
        { wrong: "感電は軽傷でも全件報告",          correct: "死亡または『病院・診療所に入院した』負傷が条件（電気関係報告規則§3①一・通院のみは対象外）" },
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：感電要件を学習教材表現「入院を要する」→ 条文表現「病院・診療所に入院した」に統一（電気関係報告規則§3①一）", reason: "B3 法令一次表現優先（feedback_law_text_accuracy.md・通院誤判定リスク遮断）" },
  ...
  return (
    <div>
      ...
      <div style={noteBox}>
        ...
        第51条本来の解説は <a href="https://kfurufuru.github.io/denken-wiki/articles/jigyoho/51/" target="_blank" rel="noopener">denken-wiki §51</a> 参照。
      </div>
      ...
      <MetaStrip
        ...
        freq="頻出"
        examType="A問題"
        targets="—（単独出題なし／§43・§51・§51の2 周辺問題に出題）"
        tags={["法令","点検","施設管理","頻出"]}
        lastChecked="2026-05-11"
      />
      ...
      <MemTable
        ...
        rows={[
          ["月次点検",     "1回以上/月", "設置者または保安担当者", "事業法§39＋告示由来 [要再確認]"],
      ...
      <TrapTable traps={[
        ...
        { wrong: "本ページは『使用前自主検査（第51条）』の解説である", correct: "ページIDは互換性保持のため shiyo-jishu-kensa のままだが、内容は通常運転中の月次/年次点検（施設管理）。第51条の使用前自主検査は denken-wiki §51 が正典" },
      ]} />

      <h2 id="quick-review">1分復習</h2>
      <QuickReview items={[
        { q: "事業用の月次点検頻度は？",        a: "原則 1回以上/月" },
        { q: "外部委託時の月次点検頻度は？",    a: "隔月（2か月に1回）または改正で条件付き3月に1回以上（KAISEI-2025-001）" },
        { q: "一般用の定期調査頻度と主体は？",  a: "電力会社が4年に1回" },
        { q: "年次点検の頻度は？",              a: "1回以上/年" },
        { q: "点検義務の法的根拠は？",          a: "電気事業法 第39条（技術基準への常時適合義務）＋施行規則・告示" },
        { q: "本ページと『使用前自主検査』の違いは？", a: "本ページ＝使用開始後の通常運転中の点検／使用前自主検査（第51条）＝工事完成後・使用開始前の検査。別制度" },
      ]} />
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：targets の誤主張（R05/R02/H29）を kakomon.yml 照合結果に基づき「単独出題なし／§43・§51・§51の2 周辺問題に出題」に誠実化", reason: "B11 phaseHoki-kakomon 主題ミスマッチ修正" },
  ...
  return (
    <div>
      ...
      <QuickReview items={[
        ...
        { q: "B種で1秒以内遮断時の抵抗値は？",         a: "600 / Ig Ω 以下（1秒超〜2秒以内なら 300/Ig）" },
      ...
      <UpdateLog entries={[
        ...
        { date: "2026-05-09", content: "B種倍々ルールの遮断時間を電技解釈第17条第2項の正規表現に修正（誤『1秒以内→300・0.5秒以内→600』→ 正『1秒超〜2秒以内→300・1秒以内→600』）。参照条文も第18条→第17条第2項に訂正", reason: "誤数値修正・古舘さん指摘" },
      ]} />
      <PageNav
...
function DensenroPage({ onNav, data }) {
  return (
    <div>
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：MetaStrip tags の典拠条文を訂正（§49は「電気使用機械器具の電圧」で架空電線路と無関係）。支持物強度の主条文 §59 に置換し、安全率セクション見出しを §59・§62 に最新化", reason: "B8 phaseHoki-G3 F3 指摘（典拠条文の正確化）" },
  ...
  return (
    <div>
      ...
      <MemTable
        ...
        note="§156 は「施設場所×工事種類」のマトリクス（入口）、§158 は合成樹脂管工事の具体仕様（PF/CD管の使い分け詳細）。点検不可の隠ぺい場所で使えるのは『金属管・PF管・ケーブル』の3つのみ。CD管は埋設専用（§158由来）"
      />
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：tags に §149（低圧分岐回路）・§158（合成樹脂管工事）を追加。§156（入口・マトリクス）と §158（PF/CD管詳細）の役割分担を見出しと note に明示", reason: "B9 phaseHoki-G3 F5/F6 指摘（kakomon.yml R02問6/H24問9 の主題対応）" },
...
function KakoDenryuPage({ onNav, data }) {
  return (
    <div>
      ...
      <UpdateLog entries={[
        { date: "2026-05-13", content: "Phase Hoki-B': hoki_check.py 検出の tag-body 整合修正 — 漏電遮断器セクション見出しに §36（地絡遮断装置の施設）を追記（tags 単独記載と本文の整合化）", reason: "hoki_check.py [tag] 唯一の検出案件・整合確保" },
...
function BunsangataDengenPage({ onNav, data }) {
  return (
    <div>
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：単独運転検出方式の典拠条文を §227（高圧連系の保護装置）→ §232（単独運転の防止）に訂正。tags §220〜§231 → §220〜§232", reason: "B1 kaishaku/232 と整合（denken-wiki SOT）" },
    ...
    <div>
      <ConclusionBox>
        <ul>
          ...
          <li>解釈は告示（電気設備の技術基準の解釈）で具体数値が示される（§33・§36/37・§156・§170-174 等は告示由来。電技省令の章番号と混同注意）</li>
      ...
      <ConclusionBox>
        <ul>
          ...
          <li><strong>電気設備技術基準の解釈</strong>（告示）→ 第1条〜第237条等の具体規定（§33過電流保護・§36-37漏電遮断・§156配線・§170-174分岐回路・§220-232分散型電源 等）</li>
          <li>📌 章別の対応表で「第33条」「第156条」のように見えても、§33以降は<strong>告示「解釈」の条文</strong>で電技省令第3章ではない。条番号だけで章帰属を判断しない</li>
        </ul>
      </ConclusionBox>
      ...
      <UpdateLog entries={[
        { date: "2026-05-11", content: "Phase Hoki-B：4区分体系（一般用/小規模事業用/自家用/事業用）を ConclusionBox と法令階層に明示・第3章テーブルで §33/§36/§37/§149/§156/§158/§170-174 を「解釈」由来として分離（電技省令の章番号と混同しないよう注記追加）", reason: "B4 phaseHoki-G4 指摘（2分体系→4区分・省令vs解釈の章帰属混乱解消）" },
