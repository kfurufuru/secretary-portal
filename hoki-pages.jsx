  ...
  return (
    <div id="demand-kanri">
      ...
      <TrapTable traps={[
        ...
        { wrong: "目標エネルギーを 300×30=9,000 以下と設定（境界値OK扱い）", correct: "「未満」なので 9,000 kW·分は含まない。9,000 未満（=8,999 以下）" },
        ...
        { wrong: "停止後P=278kWなのに「280kWを下回ったから十分」と3台で答える", correct: "3台はX=3で3.64未満。3台停止ではP=300-16.5=283.5kW>280でNG" },
      ]} />
