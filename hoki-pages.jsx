  ...
  return (
    <div>
      ...
      <div style={{background: '#fff', border: '1px solid var(--line)', borderRadius: 'var(--radius)', padding: 16, marginBottom: 24}}>
        <div style={{fontSize: 12, color: 'var(--ink-3)', marginBottom: 10}}>▼ 図1：三相回路全体の接続図（SR + SC 設備の位置）</div>
        <svg viewBox="0 0 820 260" style={{width: '100%', height: 'auto'}}>
          <defs>
            <marker id="arrowMain" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto">
              <path d="M0,0 L10,5 L0,10 z" fill="#444"/>
            </marker>
          </defs>
          {/* 電源（左） */}
          <circle cx="80" cy="130" r="40" fill="none" stroke="#555" strokeWidth="2"/>
          <text x="80" y="124" textAnchor="middle" fontSize="12" fontWeight="700" fill="#333">電源</text>
          <text x="80" y="140" textAnchor="middle" fontSize="11" fill="#666">6,600V</text>
          {/* 母線（上下） */}
          <line x1="120" y1="100" x2="560" y2="100" stroke="#333" strokeWidth="3"/>
          <line x1="120" y1="160" x2="560" y2="160" stroke="#333" strokeWidth="3"/>
          <text x="340" y="88" textAnchor="middle" fontSize="11" fill="#666">母線（高圧）</text>
          {/* 負荷（右上） */}
          <line x1="420" y1="100" x2="420" y2="80" stroke="#555" strokeWidth="1.5"/>
          <line x1="420" y1="160" x2="420" y2="200" stroke="#555" strokeWidth="1.5"/>
          <rect x="360" y="200" width="120" height="50" rx="6" fill="none" stroke="#555" strokeWidth="2"/>
          <text x="420" y="222" textAnchor="middle" fontSize="12" fontWeight="700" fill="#333">三相負荷</text>
          <text x="420" y="238" textAnchor="middle" fontSize="11" fill="#666">300kW・cosφ=0.6</text>
          <line x1="420" y1="80" x2="420" y2="60" stroke="#555" strokeWidth="1.5"/>
          <rect x="380" y="48" width="80" height="24" rx="4" fill="#fff5e6" stroke="#888" strokeWidth="1.5"/>
          <text x="420" y="64" textAnchor="middle" fontSize="11" fill="#888">三相接続</text>
          {/* 進相コンデンサ設備（右下） */}
          <line x1="240" y1="100" x2="240" y2="80" stroke="#27c" strokeWidth="2"/>
          <line x1="240" y1="160" x2="240" y2="200" stroke="#27c" strokeWidth="2"/>
          {/* SR ボックス */}
          <rect x="190" y="200" width="100" height="30" rx="5" fill="#fde" stroke="#c66" strokeWidth="2"/>
          <text x="240" y="219" textAnchor="middle" fontSize="12" fontWeight="700" fill="#c66">SR（直列リアクトル）</text>
          {/* SC ボックス */}
          <rect x="190" y="238" width="100" height="30" rx="5" fill="#e0eeff" stroke="#27c" strokeWidth="2"/>
          <text x="240" y="257" textAnchor="middle" fontSize="12" fontWeight="700" fill="#27c">SC（進相コンデンサ）</text>
          <line x1="240" y1="80" x2="240" y2="60" stroke="#27c" strokeWidth="2"/>
          <rect x="180" y="48" width="120" height="24" rx="4" fill="#e0eeff" stroke="#27c" strokeWidth="1.5"/>
          <text x="240" y="64" textAnchor="middle" fontSize="11" fill="#27c" fontWeight="700">進相コンデンサ設備</text>
          {/* 並列であることを示すブレース */}
          <line x1="300" y1="130" x2="350" y2="130" stroke="#888" strokeWidth="1.5" strokeDasharray="4,2"/>
          <text x="325" y="125" textAnchor="middle" fontSize="10" fill="#888">並列</text>
          {/* 電流矢印 */}
          <line x1="130" y1="96" x2="190" y2="96" stroke="#e87" strokeWidth="2" markerEnd="url(#arrowMain)"/>
          <text x="160" y="86" textAnchor="middle" fontSize="10" fill="#e87">遅れ電流</text>
          <line x1="560" y1="130" x2="680" y2="130" stroke="#396" strokeWidth="2" markerEnd="url(#arrowMain)"/>
          <text x="620" y="122" textAnchor="middle" fontSize="10" fill="#396" fontWeight="700">力率改善後</text>
          <text x="620" y="144" textAnchor="middle" fontSize="10" fill="#396">（合成電流が小さくなる）</text>
          {/* ラベル */}
          <text x="240" y="130" textAnchor="middle" fontSize="10" fill="#27c" fontWeight="700">← 並列接続</text>
        </svg>
      </div>
      ...
      <div style={{background: '#fff', border: '1px solid var(--line)', borderRadius: 'var(--radius)', padding: 16, marginBottom: 16}}>
        ...
        <svg viewBox="0 0 720 200" style={{width: '100%', height: 'auto'}}>
          ...
          <text x="245" y="84" textAnchor="middle" fontSize="12" fontWeight="700" fill="#c66">SR    jXL</text>
          {/* SR→SC */}
          ...
          <text x="445" y="84" textAnchor="middle" fontSize="12" fontWeight="700" fill="#27c">SC  −jXc</text>
          {/* SC→負荷端子 */}
