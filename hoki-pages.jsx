  ...
  return (
    <div id="demand-kanri">
      ...
      <div className="topic" style={{marginBottom:16, fontSize:14}}>
        <strong>問題文の読み替え</strong>：「9:00〜9:30の<strong>最大需要電力</strong>を300kW未満」
        ＝「その30分区間の<strong>平均電力を300kW未満に抑える</strong>（30分デマンドを300kW未満に制御する）」。
        最大需要電力はデマンド周期内の<em>平均電力</em>なので、瞬時値ではなく区間全体の平均で判断する。
      </div>
      ...
      <div className="topic" style={{marginBottom:20, fontSize:14}}>
        <strong>重要前提</strong>：最大需要電力は<strong>瞬間値ではなく30分平均</strong>で判断する。
        瞬時に310kWを超えていても、30分間の平均が300kW未満であれば目標達成。
      </div>
