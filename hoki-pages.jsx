    ...
    <div>
      ...
      <ConclusionBox>
        <ul>
          ...
          <li><strong>道路横断</strong>: 低高圧共通6m / 特高6m</li>
    ...
    <div>
      ...
      <div style={successBox}>
        ...
        <ol style={{margin: 0, paddingLeft: 22, lineHeight: 1.95}}>
          ...
          <li><strong>電気事業法 43 条は項番が問われる</strong>。<strong>1 項＝選任義務 / 2 項＝許可選任 / 3 項＝届出 / 4 項＝誠実義務 / 5 項＝指示遵守義務</strong>（特に 2 項と 3 項の入れ替えに注意）</li>
      ...
      <MemTable
        ...
        rows={[
          ...
          ["2 項","免状を持たない者を許可により主任技術者として選任","「届出」と入れ替える誤選択肢が定番"],
          ["3 項","主任技術者の選任・解任の届出（遅滞なく）","「許可」と入れ替える誤選択肢が定番（2 項とのペア注意）"],
          ["4 項","主任技術者の誠実義務（職務を誠実に行う）","「責任」「監督」キーワードと混同させる選択肢"],
          ["5 項","従業者の指示遵守義務（主任技術者の指示に従う）","主任技術者→従業者の方向。逆向きに書かれた誤選択肢に注意"],
        ]}
      ...
      <MemTable
        ...
        rows={[
          ...
          ["選任許可",     "免状を持たない者を、許可により主任技術者として選任する",                       "法 43 条 2 項"],
      ...
      <TrapTable traps={[
        ...
        { wrong: "免状なしでも自由に選任できる",                                    correct: "許可を受ければ、免状を持たない者を主任技術者として選任できる（43 条 2 項）" },
      ...
      <QuickReview items={[
        ...
        { q: "電気事業法 43 条 2 項は？",                         a: "免状を持たない者の許可選任" },
        { q: "電気事業法 43 条 3 項は？",                         a: "主任技術者の選任・解任の届出（遅滞なく）" },
        { q: "電気事業法 43 条 4 項は？",                         a: "主任技術者の誠実義務" },
        { q: "電気事業法 43 条 5 項は？",                         a: "従業者の指示遵守義務（主任技術者の指示に従う）" },
