...
function HichuseiJirakuPage({ onNav, data }) {
  return (
    <div>
      ...
      <h2 id="explain1">5. 深掘り解説①: なぜ「線間電圧V」を「対地電圧V/√3」に変換するのか</h2>
      <PlainExplain>
      ...
      <h2 id="explain2">6. 深掘り解説②: なぜ静電容量を「3相分」考慮するのか</h2>
      <PlainExplain>
      ...
      <h2 id="explain3">7. 深掘り解説③: 健全相√3倍の物理的意味</h2>
      <PlainExplain>
        ...
        <p style={{margin: '10px 0 0', fontSize: 13, color: 'var(--ink-3)'}}>💡 試験速攻判定：「1線地絡 → 健全相は線間電圧Vで充電される」→ I_g = √3 × ωC × V が秒で出る</p>
      </PlainExplain>

      <h2 id="explain4">8. 深掘り解説④: なぜC₁とC₂で電流が分かれるのか（回路図）</h2>
      <PlainExplain>
      ...
      <h2 id="explain5">9. 深掘り解説⑤: 保護動作シーケンス（地絡発生→系統切離）</h2>
      <div style={{background: '#fff', border: '1px solid var(--line)', borderRadius: 'var(--radius)', padding: 16, marginBottom: 24}}>
      ...
      <h2 id="solve">10. 解き方・判断手順（5ステップ）</h2>
      ...
      <h2 id="exam-r05">13. 過去問: R05下 問11</h2>
      <ExamQuestion
        year="令和5年下期"
        qNum="11"
      ...
      <h2 id="related-problems">14. 類題対応シナリオ</h2>
      <MemTable
      ...
      <h2 id="cross-ref">16. 掛け算出題パターン</h2>
      <CrossRef patterns={[
      ...
      <UpdateLog entries={[{ date: "2026-05-06", content: "初版作成（R05下問11対応）", reason: "R05下出題確認・容量性地絡電流の独立ページ化" }]} />
      <PageNav
