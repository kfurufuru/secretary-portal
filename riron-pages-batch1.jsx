...
const CapacitorPage = ({ onNav }) => (
  <>
    ...
    <PageNav prev={{id:"coulomb-field", title:"1.0 静電気"}} next={{id:"electromagnetic-force", title:"1.2 電磁力"}} onNav={onNav} />
  </>
);
...
const ThreePhasePage = ({ onNav }) => (
  <>
    ...
    <PageNav prev={{id:"transient", title:"3.2 過渡現象"}} next={{id:"semiconductor", title:"4.2 半導体"}} onNav={onNav} />
  </>
);
